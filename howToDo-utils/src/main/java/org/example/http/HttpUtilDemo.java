 ...
 * @date ：Created in 2020/5/8 22:07
...
//		connManager.setDefaultSocketConfig(socketConfig);
     ...
     * @throws IOException
     */
    public static String post(String interfaceName, Map<String, String> requestProp) throws IOException {
        String responseBody = "";
        //CloseableHttpClient httpClient = HttpClients.createDefault();
        //支持https
        CloseableHttpClient httpClient = getHttpClient();
...
//            }
//        }
        String url = "https://10.45.10.12/api/services/" + interfaceName;
...
//        }
        ...
        Map.Entry prop = null;
        if (requestProp != null) {
            for (Iterator iter = requestProp.entrySet().iterator(); iter.hasNext();) {
                prop = (Map.Entry) iter.next();
                jsonReq.put((String) prop.getKey(), (String) prop.getValue());
            }
        }
